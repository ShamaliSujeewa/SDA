...
shinyUI(
  ...
  #Start Page
  dashboardPage(skin = "purple", title = "SDA:Survey Data Analyzer",
                ...
                dashboardSidebar(
                  ...
                  sidebarMenu(
                    ...
                    menuItem("About", tabName = "AAp", icon=icon("book")),
                    ...
                    menuItem("Demonstration with Demo data",style = "color:white; font-size: 16 px; font-weight:bold",
                             menuItem("Factor Identification", tabName = "DFI", icon=icon("bookmark")),
                    ...
                    menuItem("Factor Identification", style = "color:white; font-size: 16 px; font-weight:bold" ,
                             ...
                             menuItem("Binary Logistic Model",tabName = "BM",icon=icon("building")),
                    ...
                    menuItem("Group Comparison Test", style = "color:white; font-size: 16 px; font-weight:bold" ,
                             ...
                             menuItem("Sumarry Statistics", tabName = "SS",icon=icon("columns")),
                             
                             tags$b(align="center", p("-------Statistical Test-------")),
                             menuItem("ANOVA Test", tabName = "AT", icon=icon("chrome")),
                             menuItem("Check ANOVA assumptions", tabName = "AAs", icon=icon("check")),
                             menuItem("Kruskal-Wallis rank sum test", tabName = "KT", icon=icon("codepen")),
                             
                             tags$b(align="center", p("----------Hypothesis Test-----------")),
                             menuItem("t test", tabName = "ZT" , icon=icon("cube")),
                             menuItem("Wilcoxon Signed rank test", tabName = "WT", icon=icon("cubes"))
                    ),
